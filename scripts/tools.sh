...
chmod +x terraform && mv terraform /tmp/zzz/
...
chmod +x kubectl && mv kubectl /tmp/zzz/
...
chmod +x linux-$CPUARCH/helm && mv linux-$CPUARCH/helm /tmp/zzz && \
...
chmod +x tobs* && mv tobs* /tmp/zzz/tobs
